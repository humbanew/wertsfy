 ...
 */
export type ConversationGlobalPluginsOverwritten = ConversationGlobalPluginsOverride extends {
 ...
 */
export type ConversationGlobalPlugins = ConversationGlobalPluginsOverwritten["globalPlugins"];
/**
 ...
 */
export type PluginNameFromPlugins<TPlugins extends ConversationPlugin[], TPlugin = TPlugins extends ConversationPlugin[] ? TPlugins[number] : string, TPluginDefinition = TPlugin extends ConversationPlugin ? ReturnType<TPlugin["creator"]> : string> = TPluginDefinition extends {
    name: infer U;
} ? U | (string & {}) : string;
/**
 ...
 * This type is used internally to determine the type of the plugin names available in a conversation. It should have no use outside of the library.
 */
export type PluginNameFromConversationOptions<TOptions extends ConversationOptions> = TOptions["plugins"] extends ConversationPlugin[] ? PluginNameFromPlugins<TOptions["plugins"]> : string;
/**
 ...
 * This type is used internally to determine the type of the plugin names available in a conversation. It should have no use outside of the library.
 */
export type PluginNameFromConversationOptionsWithGlobalPlugins<TOptions extends ConversationOptions> = ConversationGlobalPluginsOverride extends {
    globalPlugins: ConversationPlugin[];
} ? TOptions["plugins"] extends ConversationPlugin[] ? PluginNameFromConversationOptions<TOptions> | GlobalPluginName : GlobalPluginName : PluginNameFromConversationOptions<TOptions> | (string & {});
export type PluginsFromConversationOptions<TOptions extends ConversationOptions> = TOptions["plugins"] extends ConversationPlugin[] ? TOptions["plugins"] : ConversationPlugin[];
export type PluginsFromConversationOptionsWithGlobalPlugins<TOptions extends ConversationOptions> = ConversationGlobalPluginsOverride extends {
    globalPlugins: ConversationPlugin[];
} ? TOptions["plugins"] extends ConversationPlugin[] ? PluginsFromConversationOptions<TOptions> | ConversationGlobalPlugins : ConversationGlobalPlugins : PluginsFromConversationOptions<TOptions>;
