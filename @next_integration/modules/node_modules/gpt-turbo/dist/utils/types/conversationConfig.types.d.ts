 ...
 */
export type ChatCompletionConfigOptions = Omit<Partial<CreateChatCompletionRequest>, "messages">;
/**
 ...
 */
export type ChatCompletionConfigProperties = ChatCompletionConfigOptions & Required<Pick<ChatCompletionConfigOptions, "apiKey" | "model" | "stream">>;
/**
 ...
 * @internal Only used for convenience within the `ConversationConfig` class. Not meant to be used by consumers of the library.
 */
export type ConversationConfigProperties = ConversationConfigOptions & Required<Pick<ConversationConfigOptions, "context" | "dry" | "disableModeration">>;
/**
 * @internal Only used for convenience within the `ConversationConfig` class. Not meant to be used by consumers of the library.
 */
export type ConfigProperties = ChatCompletionConfigProperties & ConversationConfigProperties;
