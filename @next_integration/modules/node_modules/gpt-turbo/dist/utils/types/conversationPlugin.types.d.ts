 ...
 */
export interface ConversationPlugin<TName extends string = string, TOut = any, TData extends ConversationPluginData = any> {
    /**
...
export interface ConversationPluginCreator<TOut = any, TData extends ConversationPluginData = any> {
    (
    /**
     ...
     */
    pluginData?: TData): ConversationPluginCreatorDefinition<TOut, TData>;
}
/**
...
export interface ConversationPluginDefinitionBase {
     ...
     */
    transformConversationCallableFunctionsJson?: (json: ConversationCallableFunctionsModel) => ConversationCallableFunctionsModel;
    /**
     ...
     */
    transformConversationConfigJson?: (json: ConversationConfigModel) => ConversationConfigModel;
    /**
     ...
     */
    transformConversationHistoryJson?: (json: ConversationHistoryModel) => ConversationHistoryModel;
    /**
     ...
     */
    transformConversationRequestOptionsJson?: (json: ConversationRequestOptionsModel) => ConversationRequestOptionsModel;
    /**
...
export type ConversationPluginDefinitionGetPluginData<TData extends ConversationPluginData> = TData extends undefined ? {
 ...
 */
export type ConversationPluginCreatorDefinition<TOut = undefined, TData extends ConversationPluginData = undefined> = ConversationPluginDefinitionBase & ConversationPluginDefinitionOutput<TOut> & ConversationPluginDefinitionGetPluginData<TData>;
/**
 ...
 */
export type ConversationPluginDefinition<TName extends string = string, TOut = undefined, TData extends ConversationPluginData = undefined> = ConversationPluginCreatorDefinition<TOut, TData> & {
    /**
 ...
 */
export type ConversationPluginData = string | number | boolean | null | undefined | Date | Array<ConversationPluginData> | {
 ...
 * ```
 */
export type ConversationPluginDefinitionFromPlugin<T extends ConversationPlugin> = T extends ConversationPlugin<infer TName, infer TOut, infer TData> ? ConversationPluginDefinition<TName, TOut, TData> : never;
