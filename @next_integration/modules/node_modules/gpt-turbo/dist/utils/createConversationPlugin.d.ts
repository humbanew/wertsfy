import { ConversationPlugin, ConversationPluginCreator, ConversationPluginData } from "./types/index.js";
/**
 ...
 */
declare const _default: <TName extends string, TOut = undefined, TData extends ConversationPluginData = undefined>(name: TName, creator: ConversationPluginCreator<TOut, TData>) => ConversationPlugin<TName, TOut, TData>;
