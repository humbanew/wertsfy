const formulaCalculoDoSistemaDeInequacoes = (expressao1: string, expressao2: string): string|void => {
...
export { formulaCalculoDoSistemaDeInequacoes as Component_math_calculator_exp_calc_sistema_de_inequacoes_method }
