const formulaCalcQuadradoDePunnetExpandido = (genotipo1: string, genotipo2: string): Array<string> => {
...
export { formulaCalcQuadradoDePunnetExpandido as Component_math_calculator_exp_calc_quadrado_de_punnet_extendido_method }
