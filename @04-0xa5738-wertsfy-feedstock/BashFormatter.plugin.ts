 ...
 * #### Intervalo de Cores RGB
 * ----
 */
declare type TRGBInterval =
  | "0"
  | "1"
  | "2"
  | "3"
 ...
 * ----
 */
declare type TFormatterModels =
  | "@normal_or_reset"
  | "@bold_or_increased_intensity"
  | "@faint_or_dim_or_decreased_intensity"
  | "@italic"
  | "@undeline"
  | "@slow_blink"
  | "@rapid_blink"
  | "@reverse_video_or_invert"
  | "@conceal_or_hide"
  | "@crossed_out_or_strike"
  | "@primary_font"
  | "@alternative_font_a"
  | "@alternative_font_b"
  | "@alternative_font_c"
  ...
  | "@superscript"
  | "@subscript"
  | "@neither_superscript_nor_subscript"
  | "@default_foreground_color"
  | "@default_background_color"
  | "@foreground_3_or_4_bits_black"
  | "@foreground_3_or_4_bits_red"
  | "@foreground_3_or_4_bits_green"
  | "@foreground_3_or_4_bits_yellow"
  | "@foreground_3_or_4_bits_blue"
  | "@foreground_3_or_4_bits_magenta"
  | "@foreground_3_or_4_bits_cyan"
  | "@foreground_3_or_4_bits_white"
  | "@foreground_3_or_4_bits_bright_black_gray"
  | "@foreground_3_or_4_bits_bright_red"
  | "@foreground_3_or_4_bits_bright_green"
  | "@foreground_3_or_4_bits_bright_yellow"
  | "@foreground_3_or_4_bits_bright_blue"
  | "@foreground_3_or_4_bits_bright_magenta"
  | "@foreground_3_or_4_bits_bright_cyan"
  | "@foreground_3_or_4_bits_bright_white"
  | "@background_3_or_4_bits_black"
  | "@background_3_or_4_bits_red"
  | "@background_3_or_4_bits_green"
  | "@background_3_or_4_bits_yellow"
  | "@background_3_or_4_bits_blue"
  | "@background_3_or_4_bits_magenta"
  | "@background_3_or_4_bits_cyan"
  | "@background_3_or_4_bits_white"
  | "@background_3_or_4_bits_bright_black_gray"
  | "@background_3_or_4_bits_bright_red"
  | "@background_3_or_4_bits_bright_green"
  | "@background_3_or_4_bits_bright_yellow"
  | "@background_3_or_4_bits_bright_blue"
  | "@background_3_or_4_bits_bright_magenta"
  | "@background_3_or_4_bits_bright_cyan"
  | "@background_3_or_4_bits_bright_white"
  | { "@foreground_8_bits": { x: TRGBInterval } }
  | { "@background_8_bits": { x: TRGBInterval } }
  | {
      "@foreground_24_bits": {
        r: TRGBInterval;
        g: TRGBInterval;
...
export class BashFormatter {
  /**
   * ![](./~srcs/feedstock-logo.png)
   * #### Estrutura de Formatação de Texto na Linha de Comando
   * ----
   */
  public formatacao: {
    simple_quote: "'";
  ...
  /**
   * ![](./~srcs/feedstock-logo.png)
   * #### Sequências de Escape de Formatação Gráfica de Texto
   * ----
   */
  public select_graphic_rendition: {
