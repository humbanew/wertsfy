...
exports.teoremaDeGirard = void 0;
var teoremaDeGirard = (expressao) => {
    ...
    if (expressao.match(pegaTermosSemIcognita) != null) {
        valores.push(expressao.match(pegaTermosSemIcognita));
    }
...
exports.teoremaDeGirard = teoremaDeGirard;
//# sourceMappingURL=teorema_girard.mdl.js.map